 ...
 */
package io.microsphere.microprofile.rest;
...
import static io.microsphere.microprofile.rest.RequestTemplate.SUPPORTED_PARAM_ANNOTATION_TYPES;
...
public class ReflectiveRequestTemplateResolver implements RequestTemplateResolver {
    ...
    public RequestTemplate resolve(Class<?> resourceClass, Method resourceMethod) {
        ...
        String uriTemplate = PathUtils.resolvePath(resourceClass, resourceMethod);
    ...
    private String resolveParamName(Annotation paramAnnotation) {
        ...
        try {
            paramName = (String) invokeMethod(paramAnnotation, "value", EMPTY_OBJECT_ARRAY);
        } catch (Exception e) {
