 ...
 * {@link io.microsphere.convert.Converter}
 *
 * @author <a href="mailto:mercyblitz@gmail.com">Mercy</a>
 * @see io.microsphere.convert.Converter
 * @since 1.0.0
 */
public class DelegatingConverter extends AbstractConverter {
    ...
    protected Object doConvert(String value) throws Throwable {
        return io.microsphere.convert.Converter.convertIfPossible(value, convertedType);
    }
}
