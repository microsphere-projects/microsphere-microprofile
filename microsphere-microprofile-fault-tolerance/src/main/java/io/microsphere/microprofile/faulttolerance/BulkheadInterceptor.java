...
import static io.microsphere.microprofile.faulttolerance.BulkheadInterceptor.BULKHEAD_PRIORITY;
...
public class BulkheadInterceptor extends AnnotatedInterceptor<Bulkhead> {
    ...
    public static final int BULKHEAD_PRIORITY = CircuitBreakerInterceptor.CIRCUIT_BREAKER_PRIORITY + 100;
